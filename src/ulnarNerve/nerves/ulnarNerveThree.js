...
class UlnarNerveThree extends Component {
    constructor() {
        super();
        this.state = {
            shadowOpacity: 0,
    ...
    handleNerveClick = () => {
        this.props.selectNerve('Ulnar Nerve 3');
        this.props.setCursorOpacity();
        setTimeout(() => {
            this.props.removeCursorOpacity();            
...
export default connect(null, mapDispatchToProps)(UlnarNerveThree);