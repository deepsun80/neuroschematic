...
import { selectPL, removePL } from '../../actions/selectMedianMuscle';

class PlNerve extends Component {
    constructor() {
        super();
        this.state = {
            shadowOpacity: 0,
...
const mapStateToProps = (state) => {
    return {
        medianMuscleColor: state.medianMuscleColor.PL
    }
}

const mapDispatchToProps = (dispatch) => {
   return bindActionCreators({ selectNerve, openNerveModal, setCursorOpacity, removeCursorOpacity, selectPL, removePL }, dispatch); 
};

export default connect(mapStateToProps, mapDispatchToProps)(PlNerve);