...
import { selectFDS, removeFDS } from '../../actions/selectMedianMuscle';

class FdsNerve extends Component {
    constructor() {
        super();
        this.state = {
            shadowOpacity: 0,
...
const mapStateToProps = (state) => {
    return {
        medianMuscleColor: state.medianMuscleColor.FDS
    }
}

const mapDispatchToProps = (dispatch) => {
   return bindActionCreators({ selectNerve, openNerveModal, setCursorOpacity, removeCursorOpacity, selectFDS, removeFDS }, dispatch); 
};

export default connect(mapStateToProps, mapDispatchToProps)(FdsNerve);