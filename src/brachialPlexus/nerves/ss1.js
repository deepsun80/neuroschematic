...
import { selectSSC, removeSSC } from '../../actions/selectBrachialPlexusMuscle';

class SubSNerveOne extends Component {
    constructor() {
        super();
        this.state = {
            textNerveOpacity: 0,
    ...
    handleNerveClick = () => {
        this.props.selectNerve('Upper Subscapular Nerve');
        this.props.setCursorOpacity();
        setTimeout(() => {
            this.props.removeCursorOpacity();            
...
const mapStateToProps = (state) => {
    return {
        brachialPlexusMuscleColor: state.brachialPlexusMuscleColor.SSC
    }
}

const mapDispatchToProps = (dispatch) => {
   return bindActionCreators({ selectNerve, openNerveModal, setCursorOpacity, removeCursorOpacity, setCursorTextOpacity, removeCursorTextOpacity, selectSSC, removeSSC }, dispatch); 
};

export default connect(mapStateToProps, mapDispatchToProps)(SubSNerveOne);