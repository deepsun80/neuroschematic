...
class MABCNerve extends Component {
    constructor() {
        super();
        this.state = {
            textNerveOpacity: 0,
    ...
    handleNerveClick = () => {
        this.props.selectNerve('Medial Antebrachial Cutaneous Nerve');
        this.props.setCursorOpacity();
        setTimeout(() => {
            this.props.removeCursorOpacity();            
...
const mapStateToProps = (state) => {
    return {
        brachialPlexusMuscleColor: state.brachialPlexusMuscleColor.BB2
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(MABCNerve);