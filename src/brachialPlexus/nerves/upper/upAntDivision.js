...
class UpAntDivision extends Component {
    constructor() {
        super();
        this.state = {
            shadowOpacity: 0,
    ...
    handleNerveClick = () => {
        this.props.selectNerve('Anterior Division 1');
        this.props.setCursorOpacity();
        setTimeout(() => {
            this.props.removeCursorOpacity();            
    ...
    render() {
        ...
        return (
            <Group>
                ...
                />
                <Line
                    points={[540, 275, 600, 250, 670, 135, 730, 100]}
                    stroke={'#fff'}
                    strokeWidth={12}
                    lineCap={'bevel'}
                    lineJoin={'bevel'}
...
export default connect(null, mapDispatchToProps)(UpAntDivision);