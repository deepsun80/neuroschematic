...
class LatCordOne extends Component {
    constructor() {
        super();
        this.state = {
            shadowOpacity: 0,
    ...
    handleNerveClick = () => {
        this.props.selectNerve('Lateral Cord 1');
        this.props.setCursorOpacity();
        setTimeout(() => {
            this.props.removeCursorOpacity();            
...
export default connect(null, mapDispatchToProps)(LatCordOne);