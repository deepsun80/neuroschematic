...
import { selectPM2, removePM2 } from '../../actions/selectBrachialPlexusMuscle';

class MPNerve extends Component {
    constructor() {
        super();
        this.state = {
            textNerveOpacity: 0,
    ...
    handleNerveClick = () => {
        this.props.selectNerve('Medial Pectoral Nerve');
        this.props.setCursorOpacity();
        setTimeout(() => {
            this.props.removeCursorOpacity();            
    ...
    render() {
        ...
        return (
            <Group offsetX={-420} offsetY={-330}>
                ...
                />
                <Text
                    text={'PECTORALIS MINOR             PECTORALIS MAJOR'}
                    x={360}
                    y={200}
                    fontSize={25}
                    fontFamily={'Teko'}
...
const mapStateToProps = (state) => {
    return {
        brachialPlexusMuscleColor: state.brachialPlexusMuscleColor.PM2
    }
}

const mapDispatchToProps = (dispatch) => {
   return bindActionCreators({ selectNerve, openNerveModal, setCursorOpacity, removeCursorOpacity, setCursorTextOpacity, removeCursorTextOpacity, selectPM2, removePM2 }, dispatch); 
};

export default connect(mapStateToProps, mapDispatchToProps)(MPNerve);