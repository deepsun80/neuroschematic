...
import { selectINT, removeINT } from '../../actions/selectBrachialPlexusMuscle';

class FirstIntercostal extends Component {
    constructor() {
        super();
        this.state = {
            textNerveOpacity: 0,
    ...
    handleNerveClick = () => {
        this.props.selectNerve('First Intercostal Nerve');
        this.props.setCursorOpacity();
        setTimeout(() => {
            this.props.removeCursorOpacity();            
    ...
    render() {
        ...
        return (
            <Group>
                <Line
                    points={[150, 495, 180, 500, 230, 550, 270, 555]}
                    stroke={'#fff'}
                    strokeWidth={12}
                    lineCap={'bevel'}
                    lineJoin={'bevel'}
...
const mapStateToProps = (state) => {
    return {
        brachialPlexusMuscleColor: state.brachialPlexusMuscleColor.INT
    }
}

const mapDispatchToProps = (dispatch) => {
   return bindActionCreators({ selectNerve, openNerveModal, setCursorOpacity, removeCursorOpacity, setCursorTextOpacity, removeCursorTextOpacity, selectINT, removeINT }, dispatch); 
};

export default connect(mapStateToProps, mapDispatchToProps)(FirstIntercostal);