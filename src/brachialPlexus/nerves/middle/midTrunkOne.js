...
import { selectTM, removeTM, selectLD, removeLD, selectSSC, removeSSC, selectPM1, removePM1 } from '../../../actions/selectBrachialPlexusMuscle';

class MidTrunkOne extends Component {
    constructor() {
        super();
        this.state = {
            shadowOpacity: 0,
    ...
    handleNerveClick = () => {
        this.props.selectNerve('Middle Trunk 1');
        this.props.setCursorOpacity();
        setTimeout(() => {
            this.props.removeCursorOpacity();            
...
export default connect(null, mapDispatchToProps)(MidTrunkOne);