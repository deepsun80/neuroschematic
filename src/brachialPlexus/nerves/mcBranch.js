...
class MCBranch extends Component {
    constructor() {
        super();
        this.state = {
    ...
    render() {
        ...
        return (
            <Group>
                <Line
                    points={[1085, 100, 1140, 90, 1220, 40, 1280, 30]}
                    stroke={'#fff'}
                    strokeWidth={15}
                    lineCap={'bevel'}
                    lineJoin={'bevel'}
                ...
                />
                <Text
                    text={'To Musculocutaneous Nerve'}
                    x={1240}
                    y={-20}
                    fontSize={23}
                    fontFamily={'Teko'}
...
export default connect(null, mapDispatchToProps)(MCBranch);