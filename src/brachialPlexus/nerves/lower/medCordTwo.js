...
import { selectBB1, removeBB1, selectBB2, removeBB2 } from '../../../actions/selectBrachialPlexusMuscle';

class LowerNerveThree extends Component {
    constructor() {
        super();
        this.state = {
            shadowOpacity: 0,
    ...
    handleNerveClick = () => {
        this.props.selectNerve('Medial Cord 2');
        this.props.setCursorOpacity();
        setTimeout(() => {
            this.props.removeCursorOpacity();            
...
export default connect(null, mapDispatchToProps)(LowerNerveThree);